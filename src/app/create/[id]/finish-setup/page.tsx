...
const FinishSetup = ({ params }: { params: { id: string } }) => {
  return (
    <>
      <div className='flex items-center mx-5 md:mx-20 pb-[100px] md:pb-[120px] relative mt-10 md:mt-16'>
        ...
        <div className='hidden lg:grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
          <div className='flex flex-col gap-4'>
            <p className='text-2xl text-brand_black font-bold'>Step 3</p>
            <h1 className='text-4xl font-bold text-brand_black'>Finish up and publish</h1>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 items-center lg:hidden'>
          ...
          <div className='flex flex-col gap-4 text-black'>
            <p className='text-base text-brand_black font-bold'>Step 3</p>
            <h1 className='text-3xl text-brand_black font-bold'>Finish up and publish</h1>
            <p className='text-base md:text-xl text-brand_black'>
              Finally, you'll choose booking settings, set up pricing, and publish your listing.
            </p>
          </div>
